 ...
 *  - #apprise
 *     - @name      Apprise 1.5 
 *     - @get       http://thrivingkings.com/apprise/
 *
 *  - #waypoints
 *     - @name      jQuery Waypoints 1.1 
 *     - @get       http://imakewebthings.github.com/jquery-waypoints/
 *
 *  - #valid 
 *     - @name      jQuery Validation Plugin 1.8.1 
 *     - @get       http://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/jquery.validate.min.js
 *     - @commented
 *
 *  - #smooth 
 *     - @name      Smooth scrolling 
 *     - @get       http://www.zachstronaut.com/posts/2009/01/18/jquery-smooth-scroll-bugs.html
 *
 *  - #log
 *     - @inherit
 */
...
;(function($) {
  ...
  $('html, body').each(function () {
  	...
  	var initScrollTop = $(this).attr('scrollTop') || 0;
